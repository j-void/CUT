...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--netG', type=str, default='resnet_9blocks', choices=['resnet_9blocks', 'resnet_6blocks', 'unet_256', 'unet_128', 'stylegan2', 'smallstylegan2', 'resnet_cat', 'resnet_seg', 'resnet_seg_film'], help='specify generator architecture')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='unaligned_with_mask', help='chooses how datasets are loaded. [unaligned | aligned | single | colorization]')
